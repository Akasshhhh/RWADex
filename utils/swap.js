...
/*
    getAmountOfTokensReceivedFromSwap:  Returns the number of RBNT/rUSD that can be received 
    when the user swaps `_swapAmountWei` amount of RBNT/rUSD.
*/
export const getAmountOfTokensReceivedFromSwap = async (
  ...
  let amountOfTokens;
  // If `RBNT` is selected this means our input value is `RBNT` which means our input amount would be
  ...
  if (ethSelected) {
    ...
    // If `RBNT` is not selected this means our input value is `Crypto Dev` tokens which means our input amount would be
...
/*
  swapTokens: Swaps `swapAmountWei` of RBNT/rUSD with `tokenToBeReceivedAfterSwap` amount of RBNT/rUSD.
*/
export const swapTokens = async (
  ...
  let tx;
  // If RBNT is selected call the `ethToCryptoDevToken` function else
  ...
  if (ethSelected) {
    ...
    // send back `tokenToBeReceivedAfterSwap` amount of `RBNT` to the user
